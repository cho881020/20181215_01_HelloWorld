        ...
        signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SignUpActivity.this,
                        String.format("ID : %s, PW : %s 로 로그인 합니다.", inputUserId, inputUserPw),
        ...
        allCheckBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    Toast.makeText(SignUpActivity.this, "체크 해제 됨.", Toast.LENGTH_LONG).show();
                    Toast.makeText(SignUpActivity.this, "여기만작업", Toast.LENGTH_SHORT).show();
                }
...
//                false 면 롱클릭 후, 일반클릭 이벤트도 실행. true면 롱클릭만 실행되고 마무리.
                return true;
            }
        });
